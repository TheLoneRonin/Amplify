...
exports.Command = exports.Server = void 0;
require("colors");
var express_1 = __importDefault(require("express"));
var body_parser_1 = __importDefault(require("body-parser"));
var commander_1 = require("commander");
Object.defineProperty(exports, "Command", { enumerable: true, get: function () { return commander_1.program; } });
...
commander_1.program
    ...
    return __generator(this, function (_a) {
        exports.Server.listen(Config_1.PORT, function () {
            console.log(("Amplify Gateway is running on PORT " + Config_1.PORT).green.bold);
        });
        return [2 /*return*/];
    });
}); });
